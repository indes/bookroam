...
import org.bookmate.entities.UserCommentBook;
...
public class ForumAPIHandler {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="api-good-add", method = RequestMethod.GET)
	public Result addGood(@RequestParam("userId") Integer userId, @RequestParam("forumCommentId") Integer forumCommentId){
		Result result = new Result();
		int result_code = forumService.addGood(userId, forumCommentId);
