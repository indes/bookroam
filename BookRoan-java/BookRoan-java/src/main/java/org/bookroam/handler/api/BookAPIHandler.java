...
import org.bookmate.entities.Result;
...
public class BookAPIHandler {
	...
	@ResponseBody
	@RequestMapping(value="api-book-add",method= RequestMethod.GET)
	public Result addBookExcute(@RequestParam("userId") Integer userId,@RequestParam("bookId") Integer bookId, @RequestParam("bookTitle") String bookTitle,
								@RequestParam("bookAuthor") String bookAuthor, @RequestParam("bookPress") String bookPress) {


		int result_code = bookService.addBook3(userId, bookId, bookTitle, bookAuthor, bookPress);
