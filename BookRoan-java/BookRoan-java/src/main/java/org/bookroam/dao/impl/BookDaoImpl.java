...
public class BookDaoImpl extends BaseDao implements BookDao {
	...
	public int insertUserBook(UserBook userBook) {
		return this.getSqlSession().insert(BOOK_NAMESPACE + "insertUserBook" , userBook);
	}

	@Override
	public int insertBook3(Book book) {
		return this.getSqlSession().insert(BOOK_NAMESPACE + "insertBook3", book);
	}
	...
	@Override
	public int addGood(UserComment userComment) {
