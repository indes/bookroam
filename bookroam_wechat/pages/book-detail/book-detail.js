...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: "http://php.bookroam.ml:8000/api/book/shared/" +  bookId,
      data: {},
      method: 'GET',
      success: function (res) {
        that.setData({ haveBookList: res.data });
      }
    })
    wx.request({
      url: "http://php.bookroam.ml:8000/api/book/recommend/" +  bookId,
      data: {},
      method: 'GET',
      success: function (res) {
        that.setData({ myBookRecommend: res.data });
      }
    })
